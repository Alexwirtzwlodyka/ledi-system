...
final class UserController
{
    ...
    public function index(array $payload = []): array { return $this->service->index($payload); }
    ...
    public function destroy(array $payload): array { return $this->service->delete((int) ($payload['user_id'] ?? 0), (int) ($payload['actor_user_id'] ?? 0), $payload['_actor'] ?? []); }
}
